...
import reviewsPageInitialPaths98e80Resource from '../../../resources/reviews-page-initial-paths-98e80'
import reviewsPageInitialPropsBcdb7Resource from '../../../resources/reviews-page-initial-props-bcdb7'
...
export async function getStaticPaths() {
  try {
    const response = await reviewsPageInitialPaths98e80Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await reviewsPageInitialPropsBcdb7Resource({
      ...context?.params,
