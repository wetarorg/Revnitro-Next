...
import internshipsPageInitialProps9284dResource from '../../resources/internships-page-initial-props-9284d'
...
export async function getStaticProps(context) {
  try {
    const response = await internshipsPageInitialProps9284dResource({
      ...context?.params,
    })
    if (!response) {
      return {
