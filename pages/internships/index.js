...
import internshipsPageInitialProps9bb38Resource from '../../resources/internships-page-initial-props-9bb38'
...
export async function getStaticProps(context) {
  try {
    const response = await internshipsPageInitialProps9bb38Resource({
      ...context?.params,
    })
    if (!response) {
      return {
