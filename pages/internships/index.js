...
import internshipsPageInitialPropsDb767Resource from '../../resources/internships-page-initial-props-db767'
...
export async function getStaticProps(context) {
  try {
    const response = await internshipsPageInitialPropsDb767Resource({
      ...context?.params,
    })
    if (!response) {
      return {
