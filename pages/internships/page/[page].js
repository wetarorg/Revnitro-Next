...
import internshipsPageInitialPathsA43b1Resource from '../../../resources/internships-page-initial-paths-a43b1'
import internshipsPageInitialProps2abfeResource from '../../../resources/internships-page-initial-props-2abfe'
...
export async function getStaticPaths() {
  try {
    const response = await internshipsPageInitialPathsA43b1Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await internshipsPageInitialProps2abfeResource({
      ...context?.params,
