...
import internshipsPageInitialPaths845d0Resource from '../../../resources/internships-page-initial-paths-845d0'
import internshipsPageInitialPropsD60e0Resource from '../../../resources/internships-page-initial-props-d60e0'
...
export async function getStaticPaths() {
  try {
    const response = await internshipsPageInitialPaths845d0Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await internshipsPageInitialPropsD60e0Resource({
      ...context?.params,
