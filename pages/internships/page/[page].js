...
import internshipsPageInitialPathsDcf9fResource from '../../../resources/internships-page-initial-paths-dcf9f'
import internshipsPageInitialProps3d51bResource from '../../../resources/internships-page-initial-props-3d51b'
...
export async function getStaticPaths() {
  try {
    const response = await internshipsPageInitialPathsDcf9fResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await internshipsPageInitialProps3d51bResource({
      ...context?.params,
