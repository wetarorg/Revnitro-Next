...
import slidersPageInitialPathsAb102Resource from '../../../resources/sliders-page-initial-paths-ab102'
import slidersPageInitialProps4da5cResource from '../../../resources/sliders-page-initial-props-4da5c'
...
export async function getStaticPaths() {
  try {
    const response = await slidersPageInitialPathsAb102Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await slidersPageInitialProps4da5cResource({
      ...context?.params,
