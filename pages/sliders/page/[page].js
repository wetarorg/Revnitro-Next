...
import slidersPageInitialPaths59002Resource from '../../../resources/sliders-page-initial-paths-59002'
import slidersPageInitialPropsFf589Resource from '../../../resources/sliders-page-initial-props-ff589'
...
export async function getStaticPaths() {
  try {
    const response = await slidersPageInitialPaths59002Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await slidersPageInitialPropsFf589Resource({
      ...context?.params,
