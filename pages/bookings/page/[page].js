...
import bookingsPageInitialPathsDd23bResource from '../../../resources/bookings-page-initial-paths-dd23b'
import bookingsPageInitialPropsEa52aResource from '../../../resources/bookings-page-initial-props-ea52a'
...
export async function getStaticPaths() {
  try {
    const response = await bookingsPageInitialPathsDd23bResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialPropsEa52aResource({
      ...context?.params,
