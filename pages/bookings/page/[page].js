...
import bookingsPageInitialPaths6fa1dResource from '../../../resources/bookings-page-initial-paths-6fa1d'
import bookingsPageInitialPropsD3fe9Resource from '../../../resources/bookings-page-initial-props-d3fe9'
...
export async function getStaticPaths() {
  try {
    const response = await bookingsPageInitialPaths6fa1dResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialPropsD3fe9Resource({
      ...context?.params,
