...
import bookingsPageInitialProps95a2aResource from '../../resources/bookings-page-initial-props-95a2a'
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialProps95a2aResource({
      ...context?.params,
    })
    if (!response) {
      return {
