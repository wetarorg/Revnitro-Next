...
import bookingsPageInitialPropsEbff1Resource from '../../resources/bookings-page-initial-props-ebff1'
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialPropsEbff1Resource({
      ...context?.params,
    })
    if (!response) {
      return {
