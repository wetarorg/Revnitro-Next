...
import bookingsPageInitialProps17fb2Resource from '../../resources/bookings-page-initial-props-17fb2'
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialProps17fb2Resource({
      ...context?.params,
    })
    if (!response) {
      return {
