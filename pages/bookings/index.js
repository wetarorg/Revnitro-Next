...
import bookingsPageInitialProps637a6Resource from '../../resources/bookings-page-initial-props-637a6'
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialProps637a6Resource({
      ...context?.params,
    })
    if (!response) {
      return {
