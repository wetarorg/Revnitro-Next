...
import bookingsPageInitialProps2579dResource from '../../resources/bookings-page-initial-props-2579d'
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialProps2579dResource({
      ...context?.params,
    })
    if (!response) {
      return {
