...
import bookingsPageInitialProps97637Resource from '../../resources/bookings-page-initial-props-97637'
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialProps97637Resource({
      ...context?.params,
    })
    if (!response) {
      return {
