...
import bookingsPageInitialProps152d0Resource from '../../resources/bookings-page-initial-props-152d0'
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialProps152d0Resource({
      ...context?.params,
    })
    if (!response) {
      return {
