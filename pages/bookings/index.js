...
import bookingsPageInitialPropsE92aaResource from '../../resources/bookings-page-initial-props-e92aa'
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialPropsE92aaResource({
      ...context?.params,
    })
    if (!response) {
      return {
