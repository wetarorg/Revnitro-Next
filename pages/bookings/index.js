...
import bookingsPageInitialProps8a709Resource from '../../resources/bookings-page-initial-props-8a709'
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialProps8a709Resource({
      ...context?.params,
    })
    if (!response) {
      return {
