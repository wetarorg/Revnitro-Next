...
import bookingsPageInitialProps68befResource from '../../resources/bookings-page-initial-props-68bef'
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialProps68befResource({
      ...context?.params,
    })
    if (!response) {
      return {
