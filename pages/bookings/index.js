...
import bookingsPageInitialProps30024Resource from '../../resources/bookings-page-initial-props-30024'
...
export async function getStaticProps(context) {
  try {
    const response = await bookingsPageInitialProps30024Resource({
      ...context?.params,
    })
    if (!response) {
      return {
